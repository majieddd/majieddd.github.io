...
var R = (function () {
  ...
  var ART = {
    ...
    grain: 0.042,
    halftone: 0.62,
    /* CANVAS WEAVE, OFF. It was a screen-space value-only texture applied
       uniformly across the ENTIRE frame regardless of what is under it,
       unlike halftone (confined to actual shadowed geometry, see the isScene
       gate above) and unlike the mesh-space paint tooth (which moves with the
       world). A screen-locked texture reads as exactly what it is: something
       sitting on the glass rather than on the paint, and that is what was
       reported: "a texture transparent overlay over the screen as a whole",
       "doesn't move". Measured before disabling it: switching it off changed
       full-frame local contrast by 0.26, about 16% of the frame's own texture
       energy, uniformly, everywhere, confirming it was doing exactly what it
