...
var DATA = (function () {
  ...
  var DENIZENS = {
    /* xeno */
    chitling:    { id: 'chitling', name: 'CHITLING', faction: 'xeno', hp: 46, speed: 4.6, bounty: 7, armor: 0, rig: 'crawler', scale: 1.18 },
    gnawling:    { id: 'gnawling', name: 'GNAWLING', faction: 'xeno', hp: 68, speed: 5.8, bounty: 9, armor: 0, rig: 'crawler', scale: 1.30, trait: 'sprinter' },
    bloatpod:    { id: 'bloatpod', name: 'BLOATPOD', faction: 'xeno', hp: 165, speed: 3.1, bounty: 16, armor: 0.10, rig: 'walker', scale: 1.52, trait: 'burst', burst: { dmg: 0, slow: 0.5, radius: 5 } },
    hivelord:    { id: 'hivelord', name: 'HIVELORD', faction: 'xeno', hp: 330, speed: 3.4, bounty: 30, armor: 0.18, rig: 'walker', scale: 1.72, trait: 'summon', summon: { of: 'chitling', every: 3.4, count: 2 } },
    broodmother: { id: 'broodmother', name: 'BROODMOTHER', faction: 'xeno', hp: 560, speed: 2.7, bounty: 52, armor: 0.24, rig: 'strider', scale: 2.05, trait: 'split', split: { into: 'gnawling', count: 3 } },
    /* shared archetypes reskinned per faction at spawn time */
    tither:      { id: 'tither', name: 'TITHER', faction: 'xeno', hp: 92, speed: 4.2, bounty: 12, armor: 0.05, rig: 'flyer', scale: 1.34, flying: true },
    graft:       { id: 'graft', name: 'GRAFT', faction: 'xeno', hp: 190, speed: 3.6, bounty: 20, armor: 0.12, rig: 'walker', scale: 1.58, trait: 'mender', mend: { rate: 22, radius: 7.5 } },
    stockman:    { id: 'stockman', name: 'STOCKMAN', faction: 'xeno', hp: 310, speed: 3.0, bounty: 26, armor: 0.34, rig: 'walker', scale: 1.70, trait: 'shield', shield: { amount: 0.55 } },
    /* boss and miniboss */
    colossus:    { id: 'colossus', name: 'COLOSSUS', faction: 'xeno', hp: 2400, speed: 2.2, bounty: 180, armor: 0.30, rig: 'strider', scale: 2.70, boss: true, trait: 'miniboss' },
    harbinger:   { id: 'harbinger', name: 'HARBINGER', faction: 'xeno', hp: 8600, speed: 1.9, bounty: 600, armor: 0.36, rig: 'strider', scale: 3.45, boss: true, trait: 'boss',
