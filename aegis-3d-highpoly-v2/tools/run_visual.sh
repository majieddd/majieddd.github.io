...
node aegis-3d-highpoly/tools/headless.js http://127.0.0.1:8741/aegis-3d-highpoly/index.html "$OUT" aegis-3d-highpoly/tools/visual.steps.cjs > /tmp/hp_vis3.log 2>&1
VIS=$?
kill $SRV 2>/dev/null
echo "VIS_EXIT=$VIS"
ls -la "$OUT" | tail -10
