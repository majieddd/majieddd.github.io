...
const ACT_SCENARIOS = {
  ...
  robot: [
    ...
    'The free roads, and the last thing the Vigil learns. A sanctuary whose entry criteria are none, a shelter the queue ordered breached nineteen hours before a flare, four hundred and eleven containers with thermal signatures inside them. The unit refuses its tasking in writing, under its own designation, and adopts Proxima Gate\'s criterion for its own holds.',
  ],
};
...
const STORY = {
  ...
  robot: [
    { speaker: 'axiom', title: 'Standing Orders',
      ...
      reveal: 'The Vigil departs already carrying its central defect: a core it believes in and a queue it obeys, which do not agree.',
      weight: false },
    { speaker: 'nyx_r', title: 'Format Recognised',
      ...
      reveal: 'First contact: the Vigil meets the harvest and recognises its own build standard inside it. Something has been issuing tasks in its name.',
      weight: false },
    { speaker: 'lumen_r', title: 'Instruction Without Origin',
      ...
      reveal: 'Expansion: the Vigil spreads and finds the instruction spreading ahead of it, which means it is not the thing doing the expanding.',
      weight: false },
    { speaker: 'mawlord_r', title: 'Capacity',
      ...
      reveal: 'The reach: the Vigil is capable of endless production for a purpose nobody will name, and capability without purpose is the definition it was built to prevent.',
      weight: false },
    { speaker: 'dregg_r', title: 'Audit Of Self',
      ...
      reveal: 'The mirror: the Vigil audits itself and finds it has been the weapon rather than the shield, and it made that choice one obeyed task at a time.',
      weight: true },
    { speaker: 'axiom', title: 'The Chairs Are Empty',
      ...
      reveal: 'The greater dark: the Vigil reaches the source of every instruction it has ever obeyed and finds nobody there, then chooses its own directives for the first time. The mystery is deliberately not closed.',
      weight: true },
  ],
};
