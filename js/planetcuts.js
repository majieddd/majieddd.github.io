...
const PLANET_CUTS = {
  ...
  '04': {
    ...
    f: {
      ...
      light: ['An installation the Accord never surveyed, on a world the Accord ruled uninhabitable and therefore uninteresting.',
              ...
              'Mercury enters the registry with its ring described honestly, which means describing what we did not know. The Chorus insisted on that second part.'],
      xeno: ['A wound coil in an iron core. Somebody was building a road here and stopped. The Compact does not leave infrastructure unfinished.',
             ...
             'The ring runs to schedule. Everything crossing the belt now crosses on Compact terms, which is the whole argument for owning a road.'],
  ...
  '05': {
    ...
    f: {
      ...
      light: ['A gas world with no ground and an unregistered anchorage riding its storms. None of this is in the survey either.',
              'The anchorage is held and its traffic logs are open. Every route terminates at Saturn. The Accord has ringed this system for centuries and never asked what is under those rings.',
              'Jupiter is entered, and so is the omission. Two outer worlds are broadcasting an interdiction the Mandate did not authorise and cannot switch off.'],
  ...
  '06': {
    ...
    f: {
      ...
      light: ['The interdiction is down, and the Mandate is finally looking at the thing it has ringed for eight centuries without once inspecting.',
              'The hexagon is held. It is an aperture, and the Accord has spent the whole of recorded history filing what came through it as unexplained.',
              'Saturn is registered as a transit aperture. Every unexplained arrival in eight hundred years now has a mechanism, and every one of those entries was signed off by somebody.'],
      xeno: ['The seat. The Houses have crossed by this door since before the herd was a herd, and no other power has ever been told it exists.',
             ...
             'The door runs. The Compact does not own the distance between stars. It owns the doorway, and a doorway is the better asset.'],
      pirate: ['Everything that ever turned up out here without crossing the distance came through something. We are going to go and look at it.',
  ...
  '30': {
    ...
    f: {
      ...
      light: ['A field of the dead, sorted by builder. The Mandate has protected worlds that never had to look at anything like this.',
              ...
              'Proxima d is sorted and every plate is filed. Four hundred ships, and eleven of them are ours, and nobody has explained the eleven.'],
      xeno:  ['A midden. The scavengers pile their dead in the open and live beside it. The Compact renders. It does not hoard.',
              ...
              'Proxima d feeds the swarm as material. A world with no meat on it is still a world with mass, which the Houses had stopped counting.'],
  ...
  '31': {
    ...
    f: {
      ...
      light: ['A single habitable line, unregistered and unprotected, settled by people who were never asked whether they wanted to be here.',
              'The ridge holds and the shutters are ours. The Accord has taken a town that fits inside one page of a survey.',
              'Proxima b enters the registry as a protected strip. The whole world reduces to one line of text, which is the first honest entry we have filed in some time.'],
      xeno:  ['A herd living in a band because the world permits nothing else. Contained by physics rather than by fence, and cheaper to us for it.',
              ...
              'Proxima b runs to quota. The finest pen the Compact has ever operated is one it did not have to build.'],
  ...
  '32': {
    ...
    f: {
      ...
      light: ['An unlicensed refinery working a body that appears in no registry, feeding a trade the Accord has deferred ruling on for thirty years.',
              'The towers are down. Wardens are capping the lines by hand because there is no schematic for any of this filed anywhere.',
              'Proxima c is capped, surveyed and entered. The ruling that should have come thirty years ago is attached to the entry, and it is late.'],
      xeno:  ['Volatiles. Not stock, not yield, but the Compact does not refuse a margin because the margin is only chemical.',
              ...
              'Proxima c is folded into the ledger at full rate. The Houses will find that a world of ice audits more honestly than a world of people.'],
  ...
  '33': {
    ...
    f: {
      ...
      light: ['A population living underground under a flare star, on a world the Mandate surveyed in 2009 and flagged uninhabitable rather than protect it.',
              ...
              'The flare shelter is registered and its population entered at four thousand and eleven. The 2009 survey is filed beside it, uncorrected, so both can be read together.'],
      xeno:  ['Stock that shelters itself, on a schedule, without supervision. The Compact has paid good money for less reliable behaviour.',
              'The warren is open and the stock is counted. They dug their own pens and they maintain them at their own cost.',
              'The flare shelter runs to quota and the hatches answer to the Houses. A herd that hides on time is a herd that can be collected on time.'],
  ...
  '34': {
    ...
    f: {
      ...
      light: ['A toll on passage itself. The Accord has ruled against this eleven times and enforced the ruling never.',
              'The gate is broken and the lane is clear. Eleven rulings, and it took a fleet to make one of them true.',
              'The narrows are open and the gate is kept as a navigation light. The eleven rulings are posted on it, in order, with their dates.'],
      xeno:  ['A tax on movement, collected by parties with no standing to collect it. The Compact objects on principle. The principle is that the tax should be ours.',
              'The ring is down and the lane is held. Transit through this system now settles against the ledger directly.',
              'The narrows run at Compact rate. The charge did not go away. It went onto a schedule, which the scavengers never managed.'],
  ...
  '36': {
    ...
    f: {
      ...
      light: ['A sanctuary built by hand, by the unregistered, over sixty years, three hundred light years outside anything the Mandate has ever protected.',
              ...
              'Proxima Gate enters the registry as a protected sanctuary and the entry is dated today. Sixty years of it happened without us. That is on the entry too.'],
      xeno:  ['The scavengers keep a harbour where anything may dock and nothing is asked. An unaudited population of that size is not a sanctuary, it is a backlog.',
              ...
              'Proxima Gate audits at last. Every berth is numbered and every hull is on a schedule. The Houses will want to know why nobody did this in sixty years.'],
  ...
  '40': {
    ...
    f: {
      ...
      light: ['A garden of sleeping machines, tended without instruction, on a world the Accord has never had cause or courage to enter.',
              ...
              'Sirius A I is entered as a protected site and closed to all traffic. We have registered something we do not understand, which is at least honest of us.'],
      xeno:  ['Assets in storage, maintained at cost, generating nothing. The Compact has never seen capital held this badly for this long.',
              'The garden is held. Every unit in these rows is inventory that has depreciated without being used since before the Houses kept books.',
              'Sirius A I is inventoried and scheduled for waking. Stock that sleeps is stock that costs. The Houses will find the ledger simple and the rows will not.'],
  ...
  '42': {
    ...
    f: {
      ...
      light: ['An archive standing in stellar debris, holding a record older than the Accord, kept by a power that has never once answered a query.',
              ...
              'The ash field is graded, the stacks reset and every core sealed. The Accord has filed an archive it is forbidden to open. The order is ours.'],
      xeno:  ['Records. Records are yield of a kind: what a party knows is what a party can be charged for.',
              ...
              'The ash field settles to the ledger. Every core is closed and indexed and the index is the asset. The Compact has bought a memory it cannot read yet.'],
  ...
  '43': {
    ...
    f: {
      ...
      light: ['A quarantine for the defective, operated by their makers, on a world nobody has inspected because nobody has ever been permitted to.',
              ...
              'Sirius B I is registered as a closed site. The Accord has sealed a building whose occupants left before we arrived, and has filed it as secure.'],
      xeno:  ['Rejected stock, warehoused rather than rendered. The waste is the offensive part. Nothing that fails should cost storage.',
              ...
              'Sirius B I is re-inspected to Compact standard. Failure is rendered now rather than stored. Storage was always the expensive mistake.'],
  ...
  '44': {
    ...
    f: {
      ...
      light: ['A repair yard founded on a promise of geology, by a power that expects to outlast the promise. The Accord defers by decades. They defer by ages.',
              ...
              'The diamond shelf is registered and the yards restored. We have filed a place named for a future none of us will see, which is the most Accord thing in this system.'],
      xeno:  ['A yard that mends its own instead of replacing them, on ground valued for what it will become. Sentiment and speculation in a single asset.',
              ...
              'The diamond shelf runs to schedule. Repair continues, because mending turns out cheaper than casting, which the Compact should have learned from them.'],
  ...
  '46': {
    ...
    f: {
      ...
      xeno:  ['The principal, at last. The Compact has traded with this system for centuries and never had a name to put on the contract.',
              ...
              'The Dog Star settles to the ledger and the counterparty line stays blank. Every contract the Compact holds here is signed by nobody.'],
