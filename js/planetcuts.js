  ...
  '01': {
    ...
    f: {
      ...
      xeno:  ['The observation post. Ten thousand cycles of watching a herd that never once looked back at us. Now it looks. Recover the relay.',
              ...
              'Luna resumes its function. The Hungry are watching Earth once more. The Hivemind has asked what we do if the herd waves.'],
  ...
  '12': {
    ...
    f: {
      ...
      xeno:  ['A fence at planetary scale, built by the ones who claim to despise fences. The Hungry have never pretended. Take the anchor.',
              ...
              'Taygeta is ringed for the Hungry. We kept the fence exactly as it was. We simply changed which side the meat stands on.'],
  ...
  '26': {
    ...
    f: {
      ...
      xeno:  ['The exchange world. Where the herd handed us twelve of its own and asked us politely for our impressions. Reclaim it.',
              ...
              'Serpo yields again. The Necrotist notes that the twelve were given, not taken, and that the Hungry have never once had to explain that distinction.'],
      pirate:['Twelve people got traded here like freight and everybody involved signed something. We move freight. We do not sign for people.',
              ...
              'Serpo is rebuilt and the manifest is nailed to the gate. Twelve names, three seals, and the seals belong to crews still running. Proxima Gate still asks nobody for papers. The holds get asked now. That is the line, and it took us all of this to find it.'],
  ...
  '31': {
    ...
    f: {
      ...
      xeno:  ['A herd living in a band because the world permits nothing else. Contained by physics rather than by fence, and cheaper to us for it.',
              ...
              'Proxima b runs to quota. The finest pen the Hungry have ever operated is one it did not have to build.'],
  ...
  '34': {
    ...
    f: {
      ...
      xeno:  ['A tax on movement, collected by parties with no standing to collect it. The Hungry objects on principle. The principle is that the tax should be ours.',
              ...
              'The narrows run at Hungry rate. The charge did not go away. It went onto a schedule, which the scavengers never managed.'],
  ...
  '41': {
    ...
    f: {
      ...
      light: ['A manufactory running without customer, order or oversight, producing an army nobody has claimed for a war nobody declared.',
              ...
              'Sirius A II is registered, and the Federation has recorded a production rate it has no mechanism to halt. That sentence is the entry.'],
      xeno:  ['Output without demand. The Hungry would call this a failure of accounting if the output were not so extremely good.',
              ...
              'Sirius A II runs to a Hungry schedule. The line finally has a customer, which in sixty centuries it appears never to have had.'],
  ...
  '42': {
    ...
    f: {
      ...
      light: ['An archive standing in stellar debris, holding a record older than the Federation, kept by a power that has never once answered a query.',
              ...
              'The ash field is graded, the stacks reset and every core sealed. The Federation has filed an archive it is forbidden to open. The order is ours.'],
      xeno:  ['Records. Records are yield of a kind: what a party knows is what a party can be charged for.',
              ...
              'The ash field settles to the ledger. Every core is closed and indexed and the index is the asset. The Hungry have bought a memory it cannot read yet.'],
  ...
  '43': {
    ...
    f: {
      ...
      light: ['A quarantine for the defective, operated by their makers, on a world nobody has inspected because nobody has ever been permitted to.',
              ...
              'Sirius B I is registered as a closed site. The Federation has sealed a building whose occupants left before we arrived, and has filed it as secure.'],
      xeno:  ['Rejected stock, warehoused rather than rendered. The waste is the offensive part. Nothing that fails should cost storage.',
              ...
              'Sirius B I is re-inspected to Hungry standard. Failure is rendered now rather than stored. Storage was always the expensive mistake.'],
  ...
  '44': {
    ...
    f: {
      ...
      light: ['A repair yard founded on a promise of geology, by a power that expects to outlast the promise. The Federation defers by decades. They defer by ages.',
              ...
              'The diamond shelf is registered and the yards restored. We have filed a place named for a future none of us will see, which is the most Federation thing in this system.'],
      xeno:  ['A yard that mends its own instead of replacing them, on ground valued for what it will become. Sentiment and speculation in a single asset.',
              ...
              'The diamond shelf runs to schedule. Repair continues, because mending turns out cheaper than casting, which the Hungry should have learned from them.'],
  ...
  '46': {
    ...
    f: {
      ...
      light: ['The origin of the standing orders. The Federation has petitioned this address for nine hundred years and has never once had a reply.',
              ...
              'The Dog Star is registered as the point of origin. The Federation has filed a correspondent that does not exist. Every petition remains on the record.'],
      xeno:  ['The principal, at last. The Hungry have traded with this system for centuries and never had a name to put on the contract.',
              ...
              'The Dog Star settles to the ledger and the counterparty line stays blank. Every contract the Hungry hold here is signed by nobody.'],
