...
| 2 | js/campaign2.js: 4 theatres, 18 planets, 63 locations, 3 acts per power | landed | C2.1-C2.10 |
...
| 8 | ENGINE: CAMPAIGN_ACTS_BY_POWER replaces campTier rotation | open | |
...
| --- | --- | --- |
| A | Mercury as a Sol planet | **bonus content.** the Solar System theatre runs five planets beyond Earth; Mercury keeps w_mercury and sits in CAMPAIGN_BONUS |
...
| C | Pleiades and Sirius | **bonus content**, parked in CAMPAIGN_BONUS. 13 of their 14 boards moved with their powers and are Proxima Centauri location boards; the Pleiades keep the Dust Wake (w_merope) as the bonus location board |
| D | Earth continents | **all seven.** North America, South America, Europe, Africa, Asia, Oceania, Antarctica. Earth is 12 locations |
| E | Act boundaries (Session 47) | **Act 1 is just Earth, Act 2 the entire Solar System, Act 3 the other two systems that exist.** Encoded for humanity word for word (C2.7); the other four powers keep their Session 46 orders, opening at home with Earth and the Solar System as one act |
...
- The Proxima theatre needs ZERO new boards: the thirteen re-parented Pleiades
  and Sirius boards plus five of the seven Proxima boards cover its eighteen
  locations (the Pleiades keep the Dust Wake as the bonus location board; the
  Narrows and the Gate went to the Zeta theatre with the pirates).
