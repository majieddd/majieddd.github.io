...
function index() {
  ...
  const TODO = [
    ...
    ['TODO', 'Re-baseline the balance pins',
     'Fifteen new units entered the muster pool. Nothing existing moved, but the pins should be re-taken before this reaches players.'],
