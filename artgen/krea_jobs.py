...
CUTSCENE_PLATES = [
    ...
    ('cut_light_intro_6','light','a vast luminous ring closed around a small blue world seen from far outside it, nothing moving, an observation gallery of still watchers in the foreground'),
    ...
    ('cut_xeno_intro_7','xeno','a sealed pact document pinned to a chitin desk under a Federation seal, ribbon and wax against wet shell'),
